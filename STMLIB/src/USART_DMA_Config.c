...
uint8_t							U2_TxBuffer[USART2_BUFFERSIZE_TX], U2_RxBuffer[USART2_BUFFERSIZE_RX];
uint8_t							U6_TxBuffer[USART6_BUFFERSIZE_TX], U6_RxBuffer[USART6_BUFFERSIZE_RX];
...
void USART2_Config(uint32_t  BaudRate)
{
	...
	//--------Config DMA USART Tx----------
	US_DMA_Struct.DMA_Channel									= DMA_Channel_4;
	US_DMA_Struct.DMA_BufferSize							= USART2_BUFFERSIZE_TX;
	US_DMA_Struct.DMA_Mode 										= DMA_Mode_Normal;
	US_DMA_Struct.DMA_DIR											= DMA_DIR_MemoryToPeripheral;
	...
	//-----------Config DMA USART Rx------------------
	US_DMA_Struct.DMA_Channel									= DMA_Channel_4;
	US_DMA_Struct.DMA_BufferSize							= USART2_BUFFERSIZE_RX;
	US_DMA_Struct.DMA_Mode 										= DMA_Mode_Normal;
	US_DMA_Struct.DMA_DIR											= DMA_DIR_PeripheralToMemory;
...
void USART6_Config(uint32_t BaudRate)
{
	...
	US_DMA_Struct.DMA_BufferSize							= USART6_BUFFERSIZE_TX;
	US_DMA_Struct.DMA_Mode 										= DMA_Mode_Normal;
	US_DMA_Struct.DMA_DIR											= DMA_DIR_MemoryToPeripheral;
	...
	//-----------Config DMA USART Rx------------------
	US_DMA_Struct.DMA_Channel									= DMA_Channel_5;
	US_DMA_Struct.DMA_BufferSize							= USART6_BUFFERSIZE_RX;
	US_DMA_Struct.DMA_Mode 										= DMA_Mode_Normal;
	US_DMA_Struct.DMA_DIR											= DMA_DIR_PeripheralToMemory;
